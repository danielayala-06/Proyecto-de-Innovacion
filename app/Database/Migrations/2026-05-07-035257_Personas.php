...
class Personas extends Migration
{
    ...
    {
        $this->forge->addField([
            'id_persona' => ['type'=>'INT', 'unsigned'=>true, 'auto_increment'=>true],
            'nombres' => ['type'=>'VARCHAR','constraint'=>100,'null'=>false],
            'apellidos' => ['type'=>'VARCHAR','constraint'=>100,'null'=>true],
            'telefono' => ['type'=>'CHAR','constraint'=>9,'null'=>false],
            'correo' => ['type'=>'VARCHAR','constraint'=>150,'null'=>true],
            'tel_alternativo' => ['type'=>'VARCHAR','constraint'=>20,'null'=>true],
            'numero_documento' => ['type'=>'VARCHAR','constraint'=>50,'null'=>false],
